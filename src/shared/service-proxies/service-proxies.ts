...
export class HFuncServiceProxy {
    ...
    protected processGetHFuncForEdit(response: HttpResponseBase): Observable<GetHFuncEditOutput> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetHFuncEditOutput.fromJS(resultData200) : new GetHFuncEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class GetHFuncEditOutput implements IGetHFuncEditOutput {
    ...
    init(data?: any) {
        if (data) {
            this.hFunc = data["hFunc"] ? HFuncEditDto.fromJS(data["hFunc"]) : <any>undefined;
        }
    }
...
export class CreateOrUpdateHFuncInput implements ICreateOrUpdateHFuncInput {
    ...
    init(data?: any) {
        if (data) {
            this.hFunc = data["hFunc"] ? HFuncEditDto.fromJS(data["hFunc"]) : new HFuncEditDto();
        }
    }
